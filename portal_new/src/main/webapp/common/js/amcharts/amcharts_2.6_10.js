...
AmCharts.AmLegend = AmCharts.Class({
    ...
    drawLegend: function() {
        ...
        this.titleWidth = a.getBBox().width + 15;
    ...
    createEntry: function(a) {
        if (!1 !== a.visibleInLegend) {
            ...
            this.switchable && d.setAttr("cursor", "pointer");
...
AmCharts.AmRectangularChart = AmCharts.Class({
    ...
    measureMargins: function() {
        ...
        k = f - d;
        b = g - d;
        for (var l = 0; l < a.length; l++) b = this.getAxisBounds(a[l], h, k, j, b),
        h = b.l,
        k = b.r,
        j = b.t,
        b = b.b;
...
AmCharts.ValueAxis = AmCharts.Class({
    ...
    draw: function() {
        ...
        if (this.logarithmic && (0 >= this.getMin(0, this.data.length - 1) || 0 >= this.minimum)) this.fire("logarithmicAxisFailed", {
            ...
            a = this.labelsSet;
            this.positionTitle();
            "radar" != k ? (k = this.viX, f = this.viY, b.translate(k, f), a.translate(k, f)) : j.toFront(); ! this.visible || h ? (b.hide(), j.hide(), a.hide()) : (b.show(), j.show(), a.show())
        }
    },
...
AmCharts.CategoryAxis = AmCharts.Class({
    ...
    draw: function() {
        ...
        if (AmCharts.ifArray(a)) {
            ...
            for (g = 0; g < this.data.length; g++) if (j = this.data[g]) k = this.parseDates && !this.equalSpacing ? Math.round((j.time - this.startTime) * this.stepWidth + this.cellWidth / 2) : this.getCoordinate(g - f),
            j.x[this.id] = k
        }
        ...
        k.category && (n = b.getCategoryIndexByValue(k.category), isNaN(n) || (h = this.getCoordinate(n - f), n = (d - h) / 2, l = new this.axisItemRenderer(this, h, k.label, !0, NaN, n, k), this.pushAxisItem(l))),
        ...
        k.date && (this.equalSpacing ? (n = b.getClosestIndex(this.data, "time", k.date.getTime(), !1, 0, this.data.length - 1), isNaN(n) || (h = this.getCoordinate(n - f))) : h = (k.date.getTime() - this.startTime) * this.stepWidth, n = (d - h) / 2, l = "H" == this.orientation ? new this.axisItemRenderer(this, h, k.label, !1, 2 * n, NaN, k) : new this.axisItemRenderer(this, h, k.label, !1, NaN, n, k), this.pushAxisItem(l)),
...
AmCharts.RecItem = AmCharts.Class({
    construct: function(a, b, d, e, f, g, h, j, k) {
        ...
        if ("H" == Y) {
            ...
            if (0 <= b && b <= ea + 1 && (0 < t && 0 < s && b + k <= ea + 1 && (ca = AmCharts.line(q, [0, t], [b + k, b + k], r, s, x), n.push(ca)), 0 < u)) M = AmCharts.line(q, [0, L, aa + L], [b, b + F, b + F], y, u, x, D),
            n.push(M);
            M = "end";
...
AmCharts.RadItem = AmCharts.Class({
    construct: function(a, b, d, e, f, g, h) {
        ...
        if ("polygons" == v) {
            ...
            F.push(b * Math.cos(j / 180 * Math.PI));
            L.push(L[0]);
            F.push(F[0]);
...
AmCharts.AmGraph = AmCharts.Class({
    ...
    createXYGraph: function() {
        ...
        for (var f = this.start; f <= this.end; f++) {
            ...
            k = h.y,
            h = d.getCoordinate(j),
            l = e.getCoordinate(k); ! isNaN(j) && !isNaN(k) && (a.push(h), b.push(l), (j = this.createBullet(g, h, l, f)) || (j = 0), this.labelText && this.positionLabel(this.createLabel(g, h, l), this.labelPosition, j))
        }
    ...
    positionLabel: function(a, b, d) {
        ...
        f = 0,
        g = this.fontSize;
        void 0 == g && (g = this.chart.fontSize);
        var g = g / 2 - 2,
        h = 0,
        j = 0;
        switch (b) {
        ...
        AmCharts.VML ? a.translate(e.x + f + h, e.y + g + j) : a.attr({
            x: f,
            y: g
        })
    },
        ...
        for (N = O; N <= E; N++) {
            ...
            if (na) {
                ...
                case "smoothedLine":
                    ...
                    break;
                case "step":
                    isNaN(P) ? n || (this.drawLineGraph(o, r, ka, la), o = [], r = [], ka = [], la = []) : (P < F && (w.isNegative = !0), m ? (isNaN(s) || (o.push(s), r.push(z - za)), r.push(z - za), o.push(A), r.push(z + Ua), o.push(A)) : (isNaN(t) || (r.push(t), o.push(A - za)), o.push(A - za), r.push(z), o.push(A + Ua), r.push(z)), s = A, t = z, V = A, W = z, ra = A, sa = z);
                    break;
                case "column":
                    if (!isNaN(P)) {
    ...
    createBullet: function(a, b, d) {
        ...
        "function" == typeof f ? (j = new f, j.chart = this.chart, a.bulletConfig && (j.availableSpace = d, j.graph = this, a.bulletConfig.minCoord = this.minCoord - d, j.bulletConfig = a.bulletConfig), j.write(e), j = j.set) : (this.chart.path && (f = this.chart.path + f), j = e.image(f, 0, 0, g, g).attr({
...
AmCharts.line = function(a, b, d, e, f, g, h, j, k) {
    ...
    f = AmCharts.dx,
    h = AmCharts.dy,
    j = "M" + (e(b[0]) + f) + "," + (e(d[0]) + h), l = 1; l < b.length; l++) j += " L" + (e(b[l]) + f) + "," + (e(d[l]) + h);
