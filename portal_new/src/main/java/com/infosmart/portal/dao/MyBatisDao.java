package com.infosmart.portal.dao;
...
public class MyBatisDao extends SqlSessionDaoSupport {
	...
	public PageInfo getListByPagination(String key, Object params, int pageNo,
		...
		try {
			List dataList = getSqlSession().selectList(key, params,
			 ...
			 * select="com.infosmart.mapper.RoleMapper.getRoleById">
			 * </association>
			 */
			this.logger.error("mybatis分页暂不支持一对一配置,暂为物理分页!请修改配置文件:" + key);
			e.printStackTrace();
			this.logger.error(e.getMessage(), e);
			// 为避免错误,默认是内存分页
			List dataList = getSqlSession().selectList(key, params);
