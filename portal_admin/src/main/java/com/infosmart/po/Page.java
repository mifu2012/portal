...
public class Page {
	...
	public String getPageStr() {
		...
		if(totalResult>0){
			...
			sb.append("		//防止过于频繁地翻页，可能引起的异常\n");
			sb.append("     //document.body.style.cursor='wait';\n");
			sb.append("   	var pagingUL=document.getElementById('pagingUL');\n");
			sb.append("  	if(pagingUL!=null) pagingUL.innerHTML='<font color=red>正在查询中，请稍候...</font>';//pagingUL.disabled=true;\n");
