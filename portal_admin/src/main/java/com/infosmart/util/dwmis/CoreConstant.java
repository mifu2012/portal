...
public class CoreConstant {
	 ...
	 * 默认保留的小数位数
	 */
	public final static int DEFAULT_DIGIT = 1;
	/**
	 ...
	 * 系统类型列表
	 */
	public static List<SystemParamGroup> SYSTEM_PARAM_GROUP_LIST = new ArrayList<SystemParamGroup>();

	static {
		/**
		 * 数据时间周期粒度
		 */
		SYSTEM_PARAM_GROUP_LIST.add(new SystemParamGroup(
				CoreConstant.KPI_PERIOD, "数据时间周期粒度"));
		/**
		 * 数据统计方式
		 */
		SYSTEM_PARAM_GROUP_LIST.add(new SystemParamGroup(CoreConstant.KPI_STAT,
				"数据统计方式"));
		/**
		 * 绩效类别
		 */
		SYSTEM_PARAM_GROUP_LIST.add(new SystemParamGroup(
				CoreConstant.KPI_GOAL_TYPE, "绩效类别"));
		/**
		 * 指标类型
		 */
		SYSTEM_PARAM_GROUP_LIST.add(new SystemParamGroup(CoreConstant.KPI_TYPE,
				"指标类型"));
		/**
		 * 指标单位
		 */
		SYSTEM_PARAM_GROUP_LIST.add(new SystemParamGroup(CoreConstant.KPI_UNIT,
				"指标单位"));

		/**
		 * 指标数量级
		 */
		SYSTEM_PARAM_GROUP_LIST.add(new SystemParamGroup(CoreConstant.KPI_SIZE,
				"指标数量级"));
		 ...
		 */
		SYSTEM_PARAM_GROUP_LIST.add(new SystemParamGroup(
				CoreConstant.MIS_EVENT, "大事记类型"));

		/**
		 * 维度类型
		 */
		SYSTEM_PARAM_GROUP_LIST.add(new SystemParamGroup(
				CoreConstant.MIS_DMNSN, "维度类型"));

		/**
		 * 一级指标类别
		 */
		SYSTEM_PARAM_GROUP_LIST.add(new SystemParamGroup(
				CoreConstant.KPI_LEVEL_TYPE_ONE, "一级指标类别"));

		/**
		 * 二级指标类别
		 */
		SYSTEM_PARAM_GROUP_LIST.add(new SystemParamGroup(
				CoreConstant.KPI_LEVEL_TYPE_TWO, "二级指标类别"));

		/**
		 * 商户看板
		 */
		SYSTEM_PARAM_GROUP_LIST.add(new SystemParamGroup(
				CoreConstant.MERCHANTS_BILLBOARDS, "商户看板配置"));

		/**
		 * 用户看板
		 */
		SYSTEM_PARAM_GROUP_LIST.add(new SystemParamGroup(
				CoreConstant.USER_BILLBOARDS, "用户看板配置"));
	}

	/**
	 * 未知图类型
	 * */
	public final static int CHART_NONE = -1;
	/**
	 * 趋势图类型
	 * */
	public final static int CHART_TREND = 0;
	/**
	 * 饼图类型
	 * */
	public final static int CHART_PIE = 1;
	/**
	 * 矩形图类型
	 * */
	public final static int CHART_RECTANGULAR = 2;
	/**
	 * 折线图类型
	 * */
	public final static int CHART_DISCOUNT = 3;
	/**
	 * 矩形+折现图类型
	 * */
	public final static int CHART_RECTANGULAR_DISCOUNT = 4;
	/**
	 * 面积图类型
	 * */
	public final static int CHART_AREA = 5;
	/**
	 * 新增URL类型
	 * */
	public final static int CHART_NEW_URL = 11;
