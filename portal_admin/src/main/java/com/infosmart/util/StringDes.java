...
public class StringDes {
	...
	private final static String DES_KEY_1 = "d4ea52a919e34e379964b28b1809da35";
	private final static String DES_KEY_2 = "647ec49314d5499089d0abff190421fa";
	private final static String DES_KEY_3 = "3500d8b78e114d409db4fa325e037f2f";
	 ...
	 * @return
	 */
	public static String StringToEnc(String sourceStr) {
		StringDes des = new StringDes();
		return des.strEnc(sourceStr, DES_KEY_1, DES_KEY_2, DES_KEY_3);
	}
	 ...
	 * @return
	 */
	public static String StringToDec(String encryptStr) {
		StringDes des = new StringDes();
		return des.strDec(encryptStr, DES_KEY_1, DES_KEY_2, DES_KEY_3);
	}

	public static void main(String[] args) {
		System.out.println(StringDes.StringToEnc("1"));
		System.out.println("-->"+StringDes.StringToDec("DD"));
	}
	...
	/*
	 * DES解密 decrypt the encrypted string to the original string
	 * 
