<%
	...
	String basePath = request.getScheme() + "://"
			...
			+ path + "/";
%>
document.writeln('<div id=meizzDateLayer style="position: absolute; width: 122px; height: 100px; z-index: 9998; display:none">');
document.writeln('<span id=tmpSelectYearLayer style="z-index:99999; position:absolute; top:2px; left:18px; display: none">');
document.writeln('</span>');
document.writeln('<table border=0 cellspacing=1 cellpadding=0 width=120px height=100px bgcolor=#cccccc onselectstart="return false"> ');
...
document.writeln('style="background:url(<%=basePath%>/js/datePicker/skin/default/img.gif) no-repeat;cursor:pointer; BACKGROUND-COLOR:#ffffff; BORDER-BOTTOM:#808080 0px outset; BORDER-LEFT:#808080 0px  ');
...
document.writeln(' <td Author=meizz align=right><input name="button" type=button style="background:url(<%=basePath%>/js/datePicker/skin/default/img.gif) no-repeat -32px 0px;cursor:pointer; BACKGROUND-COLOR:#ffffff;  ');
...
document.writeln('<td width=10 height=10 id=meizzMonth'+n+' style="font-size:12px" Author=meizz onclick=meizzMonthClick(this)></td>');n++;}
document.writeln('</tr>');}
...
document.writeln('onclick="meizzPrevY()"  onfocus="this.blur()" style="background:url(<%=basePath%>/js/datePicker/skin/default/img.gif) no-repeat;	cursor: pointer;BACKGROUND-COLOR: ');
...
document.writeln('<td   Author=meizz align=right><input name="button" type=button style="background:url(<%=basePath%>/js/datePicker/skin/default/img.gif) no-repeat -32px 0px;cursor: pointer;BACKGROUND-COLOR: ');
document.writeln('#ffffff;BORDER-BOTTOM: #808080 0px outset; BORDER-LEFT: #808080 0px outset; BORDER-RIGHT: #808080 0px ');
document.writeln('outset; BORDER-TOP: #808080 0px outset;font-size: 12px; height: 15px;width:32px;color: #ccffff; font-weight: ');
