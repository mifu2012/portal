...
<body>
	...
	<script type="text/javascript">
		...
		function checkInfo() {
			...
			/* var value = CKEDITOR && CKEDITOR.instances["editor1"] ? CKEDITOR.instances["editor1"].getData() : document.getElementById("editor1").value;
			
			  alert(value); */

			  
			//alert(CKEDITOR.instances.editor1.getData()); 
	/* 		var aa= CKEDITOR.replace('content');
			alert(aa); */
