...
<body>
	<form action="<%=path %>/role/saveAuthDwpas" name="accessForm" id="accessForm" target="result"  method="post">
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											<td width="18%" valign="middle">
												...
												<input type="checkbox" onclick="check(this);" name="templateIds" value="${template.templateId}" ${ss} 
