...
<table width="100%">
<tr>
<td align="left" width="80%"><div style="font-size:12px;font-family:'宋体';">当前位置:&nbsp;&gt;${templateName}&nbsp;&gt;&nbsp;<font color="red">产品六维度配置</font>&nbsp;</div>
</td>
</tr>
</table>
        ...
        <div class="common-box" style="height: auto" >
            <div class="left-box">
                <p>
                    ...
                    <input type="button" value="返回" onclick="javascrit:location.href='<%=path%>/dwpas/editMudole${menuId }_M.html?templateName=${templateName}&menuName=${menuName}' "  style="position: absolute; margin-left: 5px; width: 60px; height: 24px; line-height: 24px; "/>  
                	<input type="button" value="保存"  style="position: absolute; margin-left: 160px; width: 60px; height: 24px; line-height: 24px;display: none; " id="J-modify"/> 
                </p>
                <p>
                ...
                <ul style="border:1px solid #999; width:280px; height:300px; overflow-x:hidden;overflow-y:auto; font-size:14px;height: 400px;margin-left: 10px" id="J-searchul-f">
					...
					<c:otherwise>
					<li style="color: red;" >该模板下无关联的可用产品
					</li>
					</c:otherwise>
					</c:choose>
                </ul>
			...
			<div class="left-box" style="width:500px; margin-left:30px; ">
                ...
                <table>
                	...
                	<tr>
                		...
                		<option value="${menuInfo.menuCode}" >${menuInfo.menuName}</option>
                		</c:forEach>
