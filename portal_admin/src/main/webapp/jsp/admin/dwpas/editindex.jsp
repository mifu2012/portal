...
<body>
<form action="<%=path %>/dwpas/updateIndex" name="indexForm" id="indexForm" target="result"  method="post">
 <div class="search_div">
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
		<tr>
			<td align="left" width="70%"><div style="font-size:12px;font-family:'宋体';">当前位置:&nbsp;${templateName}&nbsp;&gt;&nbsp;<font color="red">${menuName}</font>&nbsp;</div>
		    </td>
		    <td align="left">
											...
											<table border="0" width="800px" cellspacing="3"
												...
												<tr>
													...
													<td width="30%"><input type="hidden"
														...
														class="jwy_layer_input" size="22" style='width: 90%;' /></td>
													<td align="center" width="15%">显示名称：</td>
													<td><input name="displayNames"
														value="${column.columnDisplayName }"
														class="jwy_layer_input" size="18" style='width: 90%;' /></td>
												</tr>
											<tr>
													<td align="center" width="15%">指标编码：</td>
													<td width="30%"><input name="commCodes"
												...
												<tr>
													...
													&nbsp;&nbsp;&nbsp;&nbsp;<input name="remarks" type="text"
														...
														id="remark${mm.index+1}${sy.index+1}" />
													</td>
												</tr>
											</table>
										</c:forEach>
...
function popwin(sign,kpiType){
	var dg = new $.dialog({
		...
		xButton:true,
		resize:true,
		page:'<%=path%>/dwpas/getAllComKpiInfo'+sign+'_'+kpiType+'.html?selectedKpiCodes='+document.getElementById(sign).value
		});
	dg.ShowDialog();
}
