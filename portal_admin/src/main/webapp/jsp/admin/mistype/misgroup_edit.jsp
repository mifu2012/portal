...
<body>
	<form action="saveeditgroup.html" name="mistypeForm" id="mistypeForm" target="result" method="post" onsubmit="return checkInfo();">
	<input type="hidden" name="groupId" id="groupId" value="0"/>
	<input id="typeNameHidden" value="${mistype.typeName}" type="hidden" />
	<table border="0" cellpadding="0" cellspacing="0">
		<tr class="info" >
			<th width="30%"><font color="red">*</font>类型组ID:</th>
			<td width="70%"><input type="text" name="typeId" id="typeId" class="input_txt" value="${mistype.typeId }"/></td>
		</tr>
		<tr class="info">
