...
<head>
<title>表格数据</title>
<link href="<%=basePath%>js/jqgrid/css/jquery-ui-1.8.21.custom.css"
...
<link href="<%=basePath%>js/jqgrid/css/ui.jqgrid.css" media="screen"
...
<script type="text/javascript"
	src="<%=basePath%>js/jqgrid/i18n/grid.locale-cn.js"></script>
<c:if test="${reportDefine.grouping == 1}">
	<script type="text/javascript" src="<%=basePath%>js/jqgrid/js/jquery.jqGrid.src.js"></script>
</c:if>
<c:if test="${reportDefine.grouping == 0}">
	<script type="text/javascript" src="<%=basePath%>js/jqgrid/js/jquery.jqGrid.min.js"></script>
</c:if>
<script type="text/javascript" src="<%=basePath%>js/jqgrid/js/jquery.jqGrid.groupHeader-0.2.js"></script>
<script type="text/javascript" src="<%=basePath%>js/jqgrid/js/tui.tablespan.js"></script>
<!-- 上面是GRID控件相关的JS和CSS -->
<script type="text/javascript"
...
　　　　 </c:if>
		...
		　　　　	</c:if>
		　　　　	//修改表格的按钮图表
		    	$("#first_pager span").css({"background-image": "url('<%=basePath%>js/jqgrid/css/images/page_first.gif')", "background-position": "0 0"});
		　　　　	$("#prev_pager span").css({"background-image": "url('<%=basePath%>js/jqgrid/css/images/page_prev.gif')", "background-position": "0 0"});
		　　　　	$("#next_pager span").css({"background-image": "url('<%=basePath%>js/jqgrid/css/images/page_next.gif')", "background-position": "0 0"});
		　　　　	$("#last_pager span").css({"background-image": "url('<%=basePath%>js/jqgrid/css/images/page_last.gif')", "background-position": "0 0"});
		    	$("#refresh_grid_datalist span").css({"background-image": "url('<%=basePath%>js/jqgrid/css/images/tool_reload.gif')", "background-position": "0 0"});
		　　　　	$("#buttonFilter span").css({"background-image": "url('<%=basePath%>js/jqgrid/css/images/tool_filter.gif')", "background-position": "0 0"});
		　　　　	$("#buttonExport span").css({"background-image": "url('<%=basePath%>js/jqgrid/css/images/tool_xls.gif')", "background-position": "0 0"});
		　　　　	$("#buttonPrint span").css({"background-image": "url('<%=basePath%>js/jqgrid/css/images/tool_print.gif')", "background-position": "0 0"});
