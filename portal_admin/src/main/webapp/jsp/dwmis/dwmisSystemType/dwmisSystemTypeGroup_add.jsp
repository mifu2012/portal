...
<body>
	<form action="save.html" name="systemTypeGroup" id="systemTypeGroup" target="result" method="post" onsubmit="return checkInfo();">
	<table border="0" cellpadding="0" cellspacing="0">
	    <tr class="info">
			<th width="35%"><font color="red">*</font>系统类型组编号:</th>
		...
		<tr class="info">
			<th width="35%"><font color="red">*</font>系统类型组名称:</th>
